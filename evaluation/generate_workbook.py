...
'Resumen': [
 ...
 ['Precisión','1.3 Acentos','WER promedio ≤ 2,0% en 5 dialectos','No ejecutado','NO EVALUADO','Faltan los 5 audios y sus guiones. Whisper Large v3 Turbo es multilingüe; no implica cumplir el umbral.'],
 ...
 ['Rendimiento','2.1 Archivo de 2 horas','RTF ≤ 0,15; GPU estable','RTF 0,1751 en prueba Tiny/CPU de 2 núcleos; GPU no medida','PARCIAL','Pipeline completo: 7200 s procesados en 1261 s, 9/9 bloques. No usa Large v3 Turbo ni RX 5600 XT, por tanto no certifica producto final.'],
...
'Evidencia': [
 ...
 ['2026-08-15','Pipeline completo 2 h','MP3 sintético','whisper.cpp 1.9.2 CPU; Tiny F16; 2 hilos; VAD off','1261 s; RTF 0,1751; 9/9 TXT','APROBADO PARA FLUJO, NO PARA TURBO/GPU'],
 ...
 ['2026-08-15','Regresión Silero CPU','30 s de silencio','Silero VAD 6.2.0 por CPU','>180 s; timeout de prueba','FALLÓ; mitigado: VAD solo Vulkan; el respaldo CPU lo omite'],
